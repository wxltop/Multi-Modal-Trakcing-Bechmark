...
class MSCOCOSeq_Depth(BaseVideoDataset):
    ...
    def __init__(self, root=None, depth_root=None, image_loader=jpeg4py_loader, data_fraction=None, split="train", version="2017", dtype='colormap'):
        """
        args:
        ...
        depth_root = env_settings().cocodepth_dir if depth_root is None else depth_root
    ...
    def get_sequence_info(self, seq_id):
        ...
        return {'bbox': bbox, 'valid': valid, 'visible': visible}  # 'mask': mask
    ...
    def _get_frames(self, seq_id):
        ...
        color_path = self.coco_set.loadImgs([self.coco_set.anns[self.sequence_list[seq_id]]['image_id']])[0]['file_name']  # '000000225919.jpg'
        depth_path = color_path[:-4] + '.png'

        color_path = os.path.join(self.img_path, color_path)
