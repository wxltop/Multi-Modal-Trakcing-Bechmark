...
# TEST
cfg.TEST = edict()
cfg.TEST.RE_CONSTRAIN_TYPE = 'simple' # complex
cfg.TEST.MAX_SCORE_DECAY = 1.0
...
cfg.TEST.UPDATE_INTERVALS.VOT2022RGBD = [200]
...
cfg.TEST.ONLINE_SIZES.VOT2022RGBD = [3]
