...
# single-gpu debug
#python tracking/train.py --script mixformer --config baseline_debug --save_dir /home/lz/PycharmProjects/MixFormer/baseline_debug --mode multiple --nproc_per_node 2
python tracking/train.py --script mixformer --config baseline_debug --save_dir /mnt/MixFormer/baseline_debug --mode multiple --nproc_per_node 2
