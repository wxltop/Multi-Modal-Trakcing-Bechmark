...
dataset_dict = dict(
    ...
    vot2020=DatasetInfo(module=pt % "vot2020", class_name="VOT2020Dataset", kwargs=dict()),
    vot2021=DatasetInfo(module=pt % "vot2021", class_name="VOT2021Dataset", kwargs=dict()),
...
def get_dataset(*args, **kwargs):
    ...
    dset = SequenceList()
    for name in args:
        dset.extend(load_dataset(name, **kwargs))
    return dset