...
def plot_draw_save():
    num_filters = [1, 2, 4, 8, 16, 32]
    j_score = [77.8, 78.5, 79.5, 79.1, 79.8, 79.8]
    ...
    ax.set(xlabel='Number of Mask Encoding Channels $D$',
           ylabel='$\mathcal{J}$-Score',
           title='Impact of Mask Encoding Channels $D$')
    plt.xscale('log', basex=2)
    plt.yticks(np.arange(77.5, 80.0, step=0.5))  # Set label locations.
