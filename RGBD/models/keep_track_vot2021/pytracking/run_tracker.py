...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
    ...
    is_oxuva = (dataset_name == 'oxuva')
    run_dataset(dataset, trackers, debug, threads, visdom_info=visdom_info, is_oxuva=is_oxuva)
...
def main():
    ...
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset, seq_name, args.debug, args.threads,
