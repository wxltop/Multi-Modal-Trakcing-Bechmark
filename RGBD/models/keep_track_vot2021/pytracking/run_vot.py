...
def clean_torch_extension_dir():
    torch_extension_dir = os.environ['TORCH_EXTENSIONS_DIR']
    lock_file = os.path.join(torch_extension_dir, '_prroi_pooling', 'lock')
