...
def run(settings):
    ...
    original_stark = torch.load(cfg.MODEL.PRETRAINED)
    ...
    net.backbone_color.load_state_dict(stark_backbone)
    net.backbone_depth.load_state_dict(stark_backbone)
    net.transformer.encoder_color.load_state_dict(stark_encoder)
    net.transformer.encoder_depth.load_state_dict(stark_encoder) #
    net.transformer.decoder.load_state_dict(stark_decoder)
    net.box_head.load_state_dict(stark_head)
    net.bottleneck_color.load_state_dict(stark_neck)
    net.bottleneck_depth.load_state_dict(stark_neck)
    net.query_embed.load_state_dict(stark_query)
