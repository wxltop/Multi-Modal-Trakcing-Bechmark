...
class STARKSActor(BaseActor):
    ...
    def forward_pass(self, data, run_box_head, run_cls_head):
        ...
        for i in range(self.settings.num_template):
            ...
            color_feat_dict_list.append(self.net(img=NestedTensor(template_color_i, template_att_i), mode='backbone_color'))
        ...
        color_feat_dict_list.append(self.net(img=NestedTensor(search_color, search_att), mode='backbone_color'))
        ...
        out_dict, _, _ = self.net(seq_dict_c=seq_dict_color, seq_dict_d=seq_dict_depth, mode="transformer", run_box_head=run_box_head, run_cls_head=run_cls_head)
