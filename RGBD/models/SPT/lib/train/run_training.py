...
def main():
    ...
    parser.add_argument('--script', type=str,  default='stark_s', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='rgbd', help="Name of the config file.")
