...
cfg.MODEL.PRETRAINED = '/data/Disk_B/xuefeng/VOT2022/SPT_FT/pretrained_networks/STARKS_ep0500.pth.tar'
# MODEL.BACKBONE
...
cfg.MODEL.TRANSFORMER.FUS_LAYERS = 2
...
# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.LR = 0.00002 #0.0001
cfg.TRAIN.WEIGHT_DECAY = 0.0001
cfg.TRAIN.EPOCH = 300
cfg.TRAIN.LR_DROP_EPOCH = 250
...
cfg.DATA.TRAIN.DATASETS_NAME = ["DepthTrack_train", "RGBD"]
