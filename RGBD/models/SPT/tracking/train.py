...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='rgbd', help='yaml configure file name')
...
def main():
    args = parse_args()
    if args.mode == "single":
        train_cmd = "python /data/Disk_C/xuefeng_space/trackers/Stark/lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d " \
