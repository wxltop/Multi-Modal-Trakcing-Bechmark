...
def run_vot2022d(tracker_name, tracker_param, run_id=None, debug=0, visdom_info=None):
    tracker = Tracker(tracker_name, tracker_param, run_id)
...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default="DeT_DiMP50_Max")
    ...
    parser.add_argument('--dtype', type=str, default='rgbd')
    parser.add_argument('--gpuid', type=str, default="1")
    args = parser.parse_args()
    # print(args.tracker_name)
    ...
    if args.dtype == 'rgbd':
        ...
        run_vot2022d(args.tracker_name, args.tracker_param, args.run_id, args.debug, visdom_info)
