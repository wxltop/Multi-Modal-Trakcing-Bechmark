...
class DiMPnet_DeT(nn.Module):
    ...
    def fusion(self, color_feat, depth_feat):
        ...
        # #for base model test
        # merged_feat['layer2'] = color_feat['layer2'].tensors +  depth_feat['layer2'].tensors 
        # merged_feat['layer3'] = color_feat['layer3'].tensors + depth_feat['layer3'].tensors
        ...
        # fusionfeat_layer2 = self.layer2_up(fusionfeat_layer2) + depth_feat['layer2'].tensors
        ...
        # fusionfeat_layer3 = self.layer3_up(fusionfeat_layer3)+depth_feat['layer3'].tensors
