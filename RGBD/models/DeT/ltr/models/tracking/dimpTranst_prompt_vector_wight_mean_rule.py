...
class DiMPnet_DeT(nn.Module):
    ...
    def __init__(self, feature_extractor, feature_extractor_depth, classifier, bb_regressor, classification_layer, bb_regressor_layer,
        ...
        self.rgb_weight = torch.nn.Parameter(torch.FloatTensor(1), requires_grad=True)
        self.depth_weight = torch.nn.Parameter(torch.FloatTensor(1), requires_grad=True)
   
        self.rgb_weight.data.fill_(0.5)
        self.depth_weight.data.fill_(0.5)
    ...
    def fusion(self, color_feat, depth_feat):
        ...
        #test all
        feat_RGB_layer2 = NestedTensor(self.RGB_layer2_relu(self.RGB_layer2_conv(color_feat['layer2'].tensors)), color_feat['layer2'].mask)
        feat_D_layer2 =  NestedTensor(self.D_layer2_relu(self.D_layer2_conv(depth_feat['layer2'].tensors)), depth_feat['layer2'].mask)
        ...
        fusionfeat_layer2 = self.layer2_up_relu(self.layer2_up(fusionfeat_layer2))
        ...
        fusionfeat_layer2 = self.rgb_weight * color_feat['layer2'].tensors + self.depth_weight * fusionfeat_layer2
        merged_feat['layer2'] = fusionfeat_layer2

        #layer3
        feat_RGB_layer3 = NestedTensor(self.RGB_layer3_relu(self.RGB_layer3_conv(color_feat['layer3'].tensors)), color_feat['layer3'].mask)
        feat_D_layer3 =  NestedTensor(self.D_layer3_relu(self.D_layer3_conv(depth_feat['layer3'].tensors)), depth_feat['layer3'].mask)
        ...
        fusionfeat_layer3 = self.layer3_up_relu(self.layer3_up(fusionfeat_layer3))
        ...
        fusionfeat_layer3 = self.rgb_weight * color_feat['layer3'].tensors + self.depth_weight * fusionfeat_layer3
