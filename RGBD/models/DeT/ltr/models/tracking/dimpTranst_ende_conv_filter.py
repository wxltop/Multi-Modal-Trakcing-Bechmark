...
from ltr.models.neck.featurefusion_ende_conv_filter import build_featurefusion_network
...
class DiMPnet_DeT(nn.Module):
    ...
    def __init__(self, feature_extractor, feature_extractor_depth, classifier, bb_regressor, classification_layer, bb_regressor_layer,
        ...
        #template 
        self.featurefusion_layer2 = build_featurefusion_network(d_model=256,dropout=0.1, nhead=8, dim_feedforward=1024,num_featurefusion_layers=1)
        self.featurefusion_layer3 = build_featurefusion_network(d_model=256,dropout=0.1, nhead=8, dim_feedforward=1024,num_featurefusion_layers=1)
    ...
    def fusion(self, color_feat, depth_feat):
        ...
        #q:rgb, kv:depth
        fusionfeat_layer2 = self.featurefusion_layer2(feat_RGB_layer2.tensors, feat_RGB_layer2.mask, feat_D_layer2.tensors, feat_D_layer2.mask,pos1_layer2[-1], pos2_layer2[-1])
        ...
        fusionfeat_layer2 = torch.max(color_feat['layer2'].tensors, fusionfeat_layer2)
        ...
        #q:rgb, kv: depth
        fusionfeat_layer3 = self.featurefusion_layer3(feat_RGB_layer3.tensors, feat_RGB_layer3.mask, feat_D_layer3.tensors, feat_D_layer3.mask, pos1_layer3[-1], pos2_layer3[-1])
        ...
        fusionfeat_layer3 = torch.max(color_feat['layer3'].tensors, fusionfeat_layer3)
