...
class DiMPnet_DeT(nn.Module):
    ...
    def __init__(self, feature_extractor, feature_extractor_depth, classifier, bb_regressor, classification_layer, bb_regressor_layer,
        ...
        self.fuse_weight_layer2 = torch.nn.Parameter(torch.FloatTensor(1), requires_grad=True)
        self.fuse_weight_layer3 = torch.nn.Parameter(torch.FloatTensor(1), requires_grad=True)
        self.fuse_weight_layer2.data.fill_(0.25)
        self.fuse_weight_layer3.data.fill_(0.25)
    ...
    def fusion(self, color_feat, depth_feat):
        ...
        #layer2
        d_layer2 = self.D_layer2_conv(depth_feat['layer2'].tensors)
        feat_RGB_layer2 = NestedTensor(self.RGB_layer2_conv(color_feat['layer2'].tensors), color_feat['layer2'].mask)
        feat_D_layer2 =  NestedTensor(d_layer2, depth_feat['layer2'].mask)
        ...
        fusionfeat_layer2 = d_layer2 + self.fuse_weight_layer2 * fusionfeat_layer2
        ...
        #layer3
        d_layer3 = self.D_layer3_conv(depth_feat['layer3'].tensors)
        feat_RGB_layer3 = NestedTensor(self.RGB_layer3_conv(color_feat['layer3'].tensors), color_feat['layer3'].mask)
        feat_D_layer3 =  NestedTensor(d_layer3, depth_feat['layer3'].mask)
        ...
        fusionfeat_layer3 = d_layer3 + self.fuse_weight_layer3 * fusionfeat_layer3
