...
from ltr.models.neck.featurefusion_detransormer import build_featurefusion_network
...
class DiMPnet_DeT(nn.Module):
    ...
    def __init__(self, feature_extractor, feature_extractor_depth, classifier, bb_regressor, classification_layer, bb_regressor_layer,
        ...
        self.fuse_weight_layer2.data.fill_(0.5)
        self.fuse_weight_layer3.data.fill_(0.5)
    ...
    def fusion(self, color_feat, depth_feat):
        ...
        fusionfeat_layer2 = self.fuse_weight_layer2 * depth_feat['layer2'].tensors + fusionfeat_layer2
        ...
        fusionfeat_layer3 = self.fuse_weight_layer3 * depth_feat['layer3'].tensors + fusionfeat_layer3
