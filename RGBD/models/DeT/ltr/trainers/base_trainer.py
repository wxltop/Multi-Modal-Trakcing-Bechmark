...
class BaseTrainer:
    ...
    def save_checkpoint(self):
        ...
        # directory = '/data1/gaoshang/CMCT-alldata-vot-relu'
        # directory = '/data1/gaoshang/CMCT-depth-vot'
        # directory = '/data1/gaoshang/CMCT-vot-lr1'
        directory = '/data1/gaoshang/CMCT-depth-vot-alldata'
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        if checkpoint is None:
            ...
            # checkpoint_list = sorted(glob.glob('{}/{}/{}_ep*.pth.tar'.format(self._checkpoint_dir,
            #                                                                  self.settings.project_path, net_type)))
            # print('{}/{}/{}_ep*.pth.tar'.format(self._checkpoint_dir, self.settings.project_path, net_type))
            checkpoint_list = sorted(glob.glob('/data1/gaoshang/CMCT-depth-vot-alldata/DiMPnet_DeT_ep*.pth.tar'))
            print('{}/{}/{}_ep*.pth.tar'.format(self._checkpoint_dir, self.settings.project_path, net_type))
            if checkpoint_list:
