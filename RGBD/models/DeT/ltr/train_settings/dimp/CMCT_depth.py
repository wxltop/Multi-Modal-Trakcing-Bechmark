...
def run(settings):
    settings.description = 'CMCT-depth.'
    ...
    input_dtype = 'depth' # 'rgb3d' # 'rgbcolormap'
    # Train datasets
    ...
    net = dimpTranst_prompt_vector_wight_mean_rule.dimp50_DeT(filter_size=settings.target_filter_sz, backbone_pretrained=True, optim_iter=5,
