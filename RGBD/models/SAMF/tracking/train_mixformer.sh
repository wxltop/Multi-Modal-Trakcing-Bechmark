...
OMP_NUM_THREADS=12 python tracking/train.py --script mixformer --config baseline_large --save_dir checkpoints/mixformer --mode multiple --nproc_per_node 8
OMP_NUM_THREADS=12 python tracking/train.py --script mixformer_online --config baseline_large --save_dir checkpoints/mixformer --mode multiple --nproc_per_node 8 --stage1_model checkpoints/mixformer/checkpoints/train/mixformer/baseline_large/MixFormer_ep0120.pth.tar
