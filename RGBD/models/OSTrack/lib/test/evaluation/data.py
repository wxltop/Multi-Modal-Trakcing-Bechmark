...
class Sequence:
    ...
    def __init__(self, name, frames, dataset, ground_truth_rect, ground_truth_seg=None, init_data=None,
                 object_class=None, target_visible=None, object_ids=None, multiobj_mode=False, text_dsp=None):
        self.name = name
        self.frames = frames
    ...
    def init_info(self):
        ...
        if self.text_dsp is not None:
            info['text_dsp'] = self.text_dsp
        return info
