...
class LaSOTDataset(BaseDataset):
    ...
    def __init__(self, part='full'):
        ...
        lens = len(self.sequence_list)
        lens_per_part = lens // 3
        if part == 'p1':
            self.sequence_list = self.sequence_list[:lens_per_part]
        elif part == 'p2':
            self.sequence_list = self.sequence_list[lens_per_part:2*lens_per_part]
        elif part == 'p3':
            self.sequence_list = self.sequence_list[2*lens_per_part:]
    ...
    def _construct_sequence(self, sequence_name):
        ...
        text_dsp_path = '{}/{}/{}/nlp.txt'.format(self.base_path, class_name, sequence_name)
        ...
        return Sequence(sequence_name, frames_list, 'lasot', ground_truth_rect.reshape(-1, 4),
                        object_class=target_class, target_visible=target_visible, text_dsp=text_dsp)
    ...
    def difficult_seq_list(self):
        sequence_list = ['basketball-1',
                         'basketball-11',
                         'basketball-6',
                         'bicycle-9',
                         'bird-2',
