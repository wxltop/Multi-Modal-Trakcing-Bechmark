...
class BaseTrainer:
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    # if epoch > (max_epochs - 10) or save_every_epoch or epoch % 20 == 0:
                    if epoch > (max_epochs - 1) or save_every_epoch or epoch % 20 == 0 or epoch == 79 or epoch == 159 or epoch > (max_epochs - 5):
                    # if save_every_epoch or epoch % 20 == 0:
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        # Load network, add map_location to gpu to solve the gpu out memory problem, refer:
        # https://www.zhihu.com/question/67209417/answer/866488638
        ...
        if 'epoch' in fields:
            # 2021.4.23 change to self.epoch - 1 to fix resume lr bug
    ...
    def load_state_dict(self, checkpoint=None, distill=False):
        ...
        missing_k, unexpected_k = net.load_state_dict(checkpoint_dict["net"], strict=True)
