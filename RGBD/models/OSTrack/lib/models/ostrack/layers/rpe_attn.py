...
from lib.models.ostrack.layers.rpe import generate_2d_concatenated_self_attention_relative_positional_encoding_index
...
class AttentionDistill(nn.Module):
    ...
    def forward(self, x, mask=None, return_attention=False):
        ...
        qkv_tuple = (qkv_out[0], qkv_out[1], qkv_out[2])

        if return_attention:
            return x, qkv_tuple, attn
        else:
            return x, qkv_tuple
