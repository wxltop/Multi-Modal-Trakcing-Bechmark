...
if __name__ == "__main__":
    ...
    key_dict = {"got10k_lmdb": "train/list.txt",
                "got10k_mask_lmdb": "train/GOT-10k_Train_000001/valid.txt",
                "lasot_lmdb": "LaSOTBenchmark.json",
                "lasot_mask_lmdb": "airplane/airplane-2/valid.txt",
                "coco_lmdb": "annotations/instances_train2017.json",
                "vid_lmdb": "cache.json",
                "youtubevos_lmdb": "cache.json",
                "saliency_lmdb": "cache.json", }
    ...
    if 'g' in dataset_str:
        ...
        datasets.append("got10k_mask_lmdb")
    if 'l' in dataset_str:
        datasets.append("lasot_lmdb")
        datasets.append("lasot_mask_lmdb")
    if 'c' in dataset_str:
        datasets.append("coco_lmdb")
    if 'v' in dataset_str:
        datasets.append("vid_lmdb")
    if 'y' in dataset_str:
        datasets.append("youtubevos_lmdb")
    if 's' in dataset_str:
        datasets.append("saliency_lmdb")
