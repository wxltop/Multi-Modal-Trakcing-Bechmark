...
# result_file = "/data/sda/v-yanbi/iccv21/LittleBoy_clean/data/got10k.namelist"
# base_dir = "/data/sda/v-yanbi/iccv21/LittleBoy_clean/data/got10k"
# result_file = "/data/sda/v-yanbi/iccv21/LittleBoy_clean/data/lasot.namelist"
# base_dir = "/data/sda/v-yanbi/iccv21/LittleBoy_clean/data/lasot"
# result_file = "/data/sda/v-yanbi/iccv21/LittleBoy/data/vid.namelist"
# base_dir = "/data/sda/v-yanbi/iccv21/LittleBoy/data/vid"
# result_file = "/data/sda/v-yanbi/iccv21/LittleBoy/data/coco.namelist"
# base_dir = "/data/sda/v-yanbi/iccv21/LittleBoy/data/coco"
