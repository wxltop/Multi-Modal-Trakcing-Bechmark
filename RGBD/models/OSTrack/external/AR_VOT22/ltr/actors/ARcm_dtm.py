...
'''2020.4.24 introducing distance transform map'''


class ARcm_dtm_Actor(BaseActor):
    def __call__(self, data):
        ...
        '''get prediction'''
        pred_dict = self.net(data['train_images'], data['test_images'],
                             data['train_anno'], data['test_dtm'])
