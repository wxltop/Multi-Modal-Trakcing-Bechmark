...
class MSCOCOSeq17_lmdb(BaseDataset):
    ...
    def __init__(self, split='train', root=None, image_loader=default_image_loader, data_fraction=None, version="2017"):
        """
        args:
            ...
            data_fraction (None) - Fraction of images to be used. The images are selected randomly. If None, all the
                                  images  will be used
        """
        root = env_settings().coco_lmdb_dir if root is None else root
        super().__init__(root, image_loader)
        print("building coco_seq17 from lmdb")
