...
class ResNet(nn.Module):
    ...
    def forward(self, x, output_layers=None):
        ...
        x = self.conv1(x)
        x = self.bn1(x)
        x = self.relu(x) # conv1: (batch,64,128,128)
