...
def load_network(network_dir=None, checkpoint=None, constructor_fun_name=None, constructor_module=None, **kwargs):
        ...
        if 'constructor' in checkpoint_dict and checkpoint_dict['constructor'] is not None:
            ...
            '''net_constr is NetConstructor in ltr/admin/model_constructor.py'''
            if constructor_fun_name is not None:
                net_constr.fun_name = constructor_fun_name # dimpnet50
            if constructor_module is not None:
                net_constr.fun_module = constructor_module # ltr.models.tracking.dimpnet
            ...
            '''dimpnet50() ---> return a DiMPnet object(a nn.Module)'''
            net = net_constr.get() # a DiMPnet object(a nn.Module)
        else:
