...
from ltr.dataset import Got10k, Lasot, ImagenetVID, ImagenetDET, \
    Youtube_VOS, Saliency, MSCOCOSeq17,DAVIS
...
def run(settings):
    ...
    dataset_train = SEsampler.SEMaskSampler([lasot_train,got_10k_train,imagenet_vid,imagenet_det,youtube_vos,saliency,coco17_train,davis],
                                        [1,1,1,1,3,3,3,2],
