...
def run_mdnet(img_list1,img_list2, init_bbox, gt=None, savefig_dir='', display=False):
    ...
    # print(result_bb[0].shape)
    # print(result.shape)
    # print(result_bb.shape)
    result = target_bbox
    ...
    if display or savefig: 
        ...
        im = ax.imshow(image1, aspect=None)
...
def get_sequence(seq,seq_home):
    result_home='/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/RGBE/models/MANet/results' # you need creat result dirpath
    img_dir1=os.path.join(seq_home,seq,'vis_imgs')
    img_dir2=os.path.join(seq_home,seq,'event_imgs')
    gt_path=os.path.join(seq_home,seq,'groundtruth.txt') 
...
data_dir="/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/data/visevent/test_subset" # set tracking dataset path

res_dir='/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/RGBE/models/MANet/results' # you need creat result dirpath
...
if __name__ == "__main__":
    ...
    data_dir = '/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/data/visevent/test_subset'
    ...
    for i in range(n_seq):
        ...
        if 'MANet311-2IC_'+seq+'.txt' not in os.listdir(res_dir):
            ...
            # Run tracker
            result, result_bb, fps = run_mdnet(img_list1, img_list2, init_bbox, savefig_dir='', display=args.display)
            print('FPS==>',fps)
