...
img_home   = "/home/wangxiao/Documents/rgb_event_tracking_benchmark/visEvent_dataset/train_subset/"
data_path1 = '/home/wangxiao/Documents/rgb_event_tracking_benchmark/visEvent_dataset/VisEvent_train_subset_vis.pkl'
data_path2 = '/home/wangxiao/Documents/rgb_event_tracking_benchmark/visEvent_dataset/VisEvent_train_subset_event.pkl'
#*********************************************************************************************************
...
def train_mdnet():
    ...
    for i in range(opts['n_cycles']):
        ...
        for j,k in enumerate(k_list):
            tic = time.time()
            pos_regions1, neg_regions1, pos_examples1, neg_examples1, idx1, \
            pos_regions2, neg_regions2, pos_examples2, neg_examples2, idx2 = dataset2[k].next1()

            # print("==>> pos_examples1: ", pos_examples1.shape[0]) 

            # import pdb 
            # pdb.set_trace() 

            if pos_examples1.shape[0] > 0 and pos_examples2.shape[0] > 0:  
