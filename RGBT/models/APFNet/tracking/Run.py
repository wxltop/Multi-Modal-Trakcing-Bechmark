...
if __name__ == "__main__":
    ...
    parser.add_argument("-dataset", default = 'lasher' )             #testing dataset
    parser.add_argument("-model_path", default ='./models/GTOT_ALL_Transformer.pth')   # your model
    parser.add_argument("-result_path", default ='/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/RGBT/APFNet/results/') #your result path
    args = parser.parse_args()
    ##your result path
    args.result_path = '/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/RGBT/models/APFNet/results/'+args.dataset+'/'+args.model_path.split('/')[-1].split('.')[0]+'/'
    #assert args.seq != '' or args.json != ''
    print(opts)

    dataset_path = os.path.join('/home/wangxiaolong/workspace/projects/Multi-Modal-Trakcing-Bechmark/data', args.dataset)     #dataset path
    if args.dataset=='RGBT234':
        pass
    elif args.dataset == 'lasher':
        dataset_path = os.path.join(dataset_path, 'testingset')
